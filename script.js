(() => {
  const i18n = {
    "zh-CN": {
      ...
      "download.title": "立即下载",
      "download.ios.desc": "通过 TestFlight 加入测试，体验最新版本。",
      "download.ios.btn": "前往 TestFlight",
      "download.ios.hint": "需要 iOS 16 及以上版本。",
      "download.android.desc": '点击下载安装包，请允许"未知来源"安装。',
      "download.android.btn": "下载 APK",
      "download.android.hint": "支持 Android 8.0 及以上版本。",
      "download.feedback.title": "反馈群",
      "download.feedback.desc": "扫码加入反馈群，提交问题或功能想法。",
    ...
    en: {
      ...
      "download.ios.desc":
        "Join the TestFlight beta to try the latest version on iOS.",
      "download.ios.btn": "Open TestFlight",
      "download.android.desc":
        "Download the APK directly. Allow installs from unknown sources.",
      "download.android.btn": "Download APK",
      "download.feedback.title": "Feedback Group",
      "download.feedback.desc":
        "Scan the QR code to join the feedback group and send issues or ideas.",
      "footer.tagline": "Powered by\n01001100 01101111 01110110 01100101",
      "footer.disclaimer":
        "Not officially affiliated with Hangzhou Dianzi University",
    },
  };
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (toggle) {
      toggle.addEventListener("click", () => {
        const next =
          (localStorage.getItem(STORAGE_KEY) || detectLang()) === "zh-CN"
            ? "en"
            : "zh-CN";
        applyLang(next);
      });
